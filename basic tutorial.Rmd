...
cum.infection.death <- cum.infection(data.infection.median.death, data.infection.death)


plot(data.infection.median$date, data.infection.median$up95, type = "l")
line(data.infection.median$date, data.infection.median$low60)
line(data.infection.median$date, data.infection.median$low30)
line(data.infection.median$date, data.infection.median$up30)
line(data.infection.median$date, data.infection.median$up60)
line(data.infection.median$date, data.infection.median$low95)
line(data.infection.median$date, data.infection.median$median)
```
