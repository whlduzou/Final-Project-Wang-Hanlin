...
plot.death <- function(time.start , time.end) {
  ...
  deaths <- epiobs(
    ...
    prior_intercept = normal(0, 0.4),
    link = scaled_logit(0.038)
  )
...
```{r fig.cap="Simulation infection until Sept. 1st, 2020", fig.align='center', }
...
```
```{r fig.cap="Simulation reproduction number until Sept. 1st, 2020", fig.align='center'}
cowplot::plot_grid(
...
```{r fig.cap="Fitness of obeservation data until Sept. 1st, 2020", fig.align='center'}
cowplot::plot_grid(
