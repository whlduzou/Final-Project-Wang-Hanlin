...
```{r fig.cap="Simulation reproduction number until Oct 1st, 2020", fig.align='center'}
...
```{r fig.cap="Fitness of obeservation data until Oct 1st, 2020", fig.align='center'}
...
```{r fig.cap="Cases, beds and death data until Oct 1st, 2020", fig.align='center'}
...
new.data <- rbind(new.data.case,new.data.bed,new.data.death)
ggplot(
  data = new.data, 
